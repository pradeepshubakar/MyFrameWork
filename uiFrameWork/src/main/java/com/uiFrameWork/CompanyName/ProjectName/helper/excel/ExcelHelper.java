...
public class ExcelHelper {
	...
	public static void main(String[] args) {
		...
		Object[][] data = excelHelper.getExcelData(ResourceHelper.getResourcePath("src/main/resources/configfile/testData.xlsx"), "Sheet1");
		System.out.println(data);
		excelHelper.updateResult(ResourceHelper.getResourcePath("src/main/resources/configfile/testData.xlsx"), "TestScripts", "Login", "PASS");
		excelHelper.updateResult(ResourceHelper.getResourcePath("src/main/resources/configfile/testData.xlsx"), "TestScripts", "Registration", "pass");
		excelHelper.updateResult(ResourceHelper.getResourcePath("src/main/resources/configfile/testData.xlsx"), "TestScripts", "AddToCart", "FAIL");
